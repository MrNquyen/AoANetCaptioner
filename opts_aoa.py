...
def parse_opt():
    ...
    parser.add_argument('--start_from', type=str, default=None,
                    ...
                    """)
    parser.add_argument('--cached_tokens', type=str, default=f'save_input\\data_ngram_pkl-idxs',
    ...
    parser.add_argument('--use_box', type=bool, default=0,
    ...
    # Training
    parser.add_argument('--train_images_use', type=int, default=20,
                    help='how many images to use to train? (-1 = all)')
...
def add_eval_options(parser):
    ...
    # For evaluation on MSCOCO images from some split:
        # Data input settings
    parser.add_argument('--input_json', type=str, default=f'{data_root_dir}\\data_inuse\\data_raw_bpe.json',
                    help='path to the json file containing additional info and vocab')
    parser.add_argument('--input_fc_dir', type=str, default=f'{data_root_dir}\\resnet101_fc',
                    help='path to the directory containing the preprocessed fc feats')
    parser.add_argument('--input_att_dir', type=str, default=f'{data_root_dir}\\resnet101_att',
                    help='path to the directory containing the preprocessed att feats')
    parser.add_argument('--input_box_dir', type=str, default=None,
                    help='path to the directory containing the boxes of att feats')
    parser.add_argument('--input_label_h5', type=str, default=f'{data_root_dir}\\data_inuse\\data_raw_bpe_label.h5',
                    help='path to the h5file containing the preprocessed dataset')
    ...
    # Save eval
    parser.add_argument('--save_eval_dir', type=str, default=f'{root_path}/evaluation', 
                    help='If calculate loss using ground truth during evaluation')
