...
def build_vocab(imgs, params):
  ...
  print('number of <unk>s: %d/%d = %.2f%%' % (bad_count, total_words, bad_count*100.0/total_words))
...
def main(params):
  ...
  for i,img in enumerate(imgs):
    ...
    if 'file_name' in img: jimg['file_path'] = os.path.join(img.get('file_path', ''), img['file_name']) # copy it over, might need
    if 'cocoid' in img:
...
if __name__ == "__main__":
  ...
  '''
    input_json_path: 
      > 'F:\\UNIVERSITY\\NCKH\\NCKH_V2\\baseline\\data\\AoA\\fixed_annotation\\data_raw.json'
      > 'F:\\UNIVERSITY\\NCKH\\NCKH_V2\\baseline\\data\\AoA\\fixed_annotation\\data_segmented.json'
    output_json_path: 
      > 'F:\\UNIVERSITY\\NCKH\\NCKH_V2\\baseline\\data\\AoA\\data_inuse\\data_raw.json'
      > 'F:\\UNIVERSITY\\NCKH\\NCKH_V2\\baseline\\data\\AoA\\data_inuse\\data_segmented.json'
    output_h5: 
      > f'{para['output_json_path']}\\data_raw'
      > f'{para['output_json_path']}\\data_segmented'
  '''
  ...
  para = {
    ...
    # Ouput json
    'output_json_path': f'{save_dir}\\save_input\\data_raw.json',
    # Output_h5
    'output_h5': f'{save_dir}\\save_input\\data_raw',
    # Image_root
