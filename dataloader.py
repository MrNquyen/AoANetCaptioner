...
from utils import load_json, save_json, load_h5, save_h5
class HybridLoader:
    """
...
class DataLoader(data.Dataset):
    ...
    def __init__(self, opt):
        ...
        self.info = load_json(self.opt.input_json)
        ...
        if self.opt.input_label_h5 != 'none':
            self.h5_label_file = load_h5(self.opt.input_label_h5)
...
class BlobFetcher():
    ...
    def get(self):
        ...
        # print("Expected ix:", ix, "Actual ix in tmp[-1]:", tmp[-1])
        if wrapped:
            self.reset()
